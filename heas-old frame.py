...
from functions import calculate_ABD_I,objective_hea_old
...
if __name__ == '__main__':
    ...
    # Optimize hyperparameters of SR
    for model_name in models.keys():
        print(f"\nOptimizing {model_name} ...")

        sampler = optuna.samplers.TPESampler(seed=42)
        study = optuna.create_study(direction='minimize', sampler=sampler)
        study.optimize(lambda trial: objective_hea_old(trial, models, model_name, X_train, y_train, param_space_old_frame), n_trials=100)
    ...
    acquisition_functions = ['EI', 'PI', 'LCB', 'Greedy', 'Pure exploration', 'Ideal']
    batch_size = 1
    ...
    for model_name, base_model in models.items():
        ...
        for af in acquisition_functions:
            ...
            while len(X_pool_active) > 0:
                ...
                true_mu_per_step[model_name][af].append(y_pool_active.tolist())
                ...
                # Record Top-K
                selected_dict[model_name][af].append(y_selected.tolist())
